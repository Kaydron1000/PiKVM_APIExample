...
//        private const string URI_PATH = "wss://192.168.1.183/api/ws";
...
//        }
//        public void SetAuthCookies(CookieCollection cookies)
//        {
...
//        {
//            int cnt = 1;
//            PushLogEvent(new LogMessage() { LogLevel = LogLevel.Information, Message = $"Attempting connection to {_WsUri.ToString()}", TimeStamp = DateTime.Now });
